...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      Mantén pulsado este botón para grabar tu voz. Suelte el botón para
      ...
      >
        <Text style={styles.welcome}>
          {state.isRecording ? "Suelta para enviar" : "Mantener presionado para grabar"}
        </Text>
        <Image style={styles.button} source={require("./assets/button.png")} />
      </Pressable>
      <Button
        title="Repetir el último mensaje"
